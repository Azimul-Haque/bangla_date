...
class BanglaDate {
    ...
    private $bn_month_dates = array(30,30,29,30,31,31,31,31,31,31,30,30); // the main changes are here and...
	private $bn_month_middate = array(14,13,14,13,14,14,15,15,15,16,15,15);	 // ...here
